    ...
    [self.camera setOnError:^(LLSimpleCamera *camera, NSError *error) {
        ...
        if([error.domain isEqualToString:LLSimpleCameraErrorDomain]) {
            if(error.code == LLSimpleCameraErrorCodeCameraPermission) {
                ...
                label.text = NSLocalizedString(@"未获取相机权限", nil);
...
//            截屏
            ...
            [cropController setAspectRatioIndex:self.ratio];
...
- (void)viewWillLayoutSubviews
{
    ...
    self.switchButton.frame=CGRectMake(KScreenwidth-50-10, KScreenheight-KIphoneSize_Widith(75), KIphoneSize_Widith(45), KIphoneSize_Widith(45));
    self.backButton.frame=CGRectMake(15, KScreenheight-KIphoneSize_Widith(75), KIphoneSize_Widith(45), KIphoneSize_Widith(45));
}
